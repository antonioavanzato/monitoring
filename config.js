...
window.CM_CONFIG = {
  ...
  // Интервал автообновления. 5 минут — это ~8 600 вызовов в месяц даже при
  // круглосуточно открытой вкладке, меньше 1% бесплатного лимита. В фоне
  // таймер вообще останавливается, а потянуть вниз можно когда угодно.
  REFRESH_MS: 300_000,
